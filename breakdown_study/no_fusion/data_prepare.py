...
if not os.path.exists("/workspace/RAP/breakdown_study/no_fusion/generated_data"):
    os.mkdir("/workspace/RAP/breakdown_study/no_fusion/generated_data")
else:
    os.system("rm -rf /workspace/RAP/breakdown_study/no_fusion/generated_data")
    os.mkdir("/workspace/RAP/breakdown_study/no_fusion/generated_data")
...
output_file_dir = "/workspace/RAP/breakdown_study/no_fusion/generated_data/"
