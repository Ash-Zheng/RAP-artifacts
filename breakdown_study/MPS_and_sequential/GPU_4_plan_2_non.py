...
def train_and_preprocessing_process(rank, nDev, nProcess, args, queue_list, input_queue_list, if_train) -> None:
    ...
    if if_train:
        ...
        # ===============================================================
        logit_input_list_1 = [torch.rand((args.batch_size,1), dtype=torch.float32, device=device)* 100000 for _ in range(16)]
        eps_list_1 = [1e-5 for _ in range(16)]
        for i in range(len(logit_input_list_1)):
            cuda_preprocess.logit(logit_input_list_1[i], eps_list_1[i])
        boxcox_input_list_2 = [torch.rand((args.batch_size,1), dtype=torch.float32, device=device)* 100000 for _ in range(21)]
        lambda_list_2 = [0.5 for _ in range(21)]
        for i in range(len(boxcox_input_list_2)):
            cuda_preprocess.boxcox(boxcox_input_list_2[i], lambda_list_2[i])
        onehot_input_list_3 = [torch.randint(0, 100000, (args.batch_size,1), dtype=torch.float, device=device) for _ in range(15)]
        low_list_3 = [0.0 for _ in range(15)]
        high_list_3 = [16.0 for _ in range(15)]
        num_classes_list_3 = [5 for _ in range(15)]
        ...
        first_input_list_4 = [torch.randint(0, 100000, (args.batch_size, 1), dtype=torch.int64, device=device) for _ in range(15)]
        x_list_4 = [1 for _ in range(15)]
        ...
        # sparse ===============================================================
        onehot_input_list_5 = [torch.randint(0, 100000, (args.batch_size,1), dtype=torch.float, device=device) for _ in range(26)]
        low_list_5 = [0.0 for _ in range(26)]
        high_list_5 = [16.0 for _ in range(26)]
        num_classes_list_5 = [5 for _ in range(26)]
        ...
        ngram_input_list_6 = [torch.randint(0, 100000, (args.batch_size, 8), dtype=torch.int64, device=device) for _ in range(26)]
        ngram_n_list_6 = [41 for _ in range(26)]
        ngram_output_list_6 = []
        ...
        first_input_list_7 = [torch.randint(0, 100000, (args.batch_size, 1), dtype=torch.int64, device=device) for _ in range(26)]
        x_list_7 = [1 for _ in range(26)]
        ...
        sigrid_hash_input_list_8 = [torch.randint(0, 100000, (args.batch_size,1), dtype=torch.int64, device=device) for _ in range(9)]
        sigrid_hash_length_list_8 = [65536 for _ in range(9)]
        ...
        clamp_input_list_9 = [torch.randint(0, 100000, (args.batch_size,1), dtype=torch.int64, device=device) for _ in range(10)]
        clamp_min_list_9 = [0 for _ in range(10)]
        clamp_max_list_9 = [65536 for _ in range(10)]
        for i in range(len(clamp_input_list_9)):
            cuda_preprocess.clamp(clamp_input_list_9[i], clamp_min_list_9[i], clamp_max_list_9[i])
        first_input_list_10 = [torch.randint(0, 100000, (args.batch_size, 1), dtype=torch.int64, device=device) for _ in range(7)]
        x_list_10 = [1 for _ in range(7)]
        ...
        sigrid_hash_input_list_11 = [torch.randint(0, 100000, (args.batch_size,1), dtype=torch.int64, device=device) for _ in range(9)]
        sigrid_hash_length_list_11 = [65536 for _ in range(9)]
        ...
        clamp_input_list_12 = [torch.randint(0, 100000, (args.batch_size,1), dtype=torch.int64, device=device) for _ in range(5)]
        clamp_min_list_12 = [0 for _ in range(5)]
        clamp_max_list_12 = [65536 for _ in range(5)]
        ...
        first_input_list_13 = [torch.randint(0, 100000, (args.batch_size, 1), dtype=torch.int64, device=device) for _ in range(12)]
        x_list_13 = [1 for _ in range(12)]
        ...
        sigrid_hash_input_list_14 = [torch.randint(0, 100000, (args.batch_size,1), dtype=torch.int64, device=device) for _ in range(7)]
        sigrid_hash_length_list_14 = [65536 for _ in range(7)]
        ...
        clamp_input_list_15 = [torch.randint(0, 100000, (args.batch_size,1), dtype=torch.int64, device=device) for _ in range(13)]
        clamp_min_list_15 = [0 for _ in range(13)]
        clamp_max_list_15 = [65536 for _ in range(13)]
        ...
        first_input_list_16 = [torch.randint(0, 100000, (args.batch_size, 1), dtype=torch.int64, device=device) for _ in range(6)]
        x_list_16 = [1 for _ in range(6)]
    ...
    for i in loop_range:
        ...
        if if_train:
            ...
            df_both = cudf.read_parquet(both_file_name)
            for _ in range(4): # 4 times preprocessing intensity for plan 2
