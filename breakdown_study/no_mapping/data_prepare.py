...
if not os.path.exists("/workspace/RAP/breakdown_study/no_mapping/generated_data"):
    os.mkdir("/workspace/RAP/breakdown_study/no_mapping/generated_data")
else:
    os.system("rm -rf /workspace/RAP/breakdown_study/no_mapping/generated_data")
    os.mkdir("/workspace/RAP/breakdown_study/no_mapping/generated_data")
...
for i in range(args.nDev):
    generate_parquet_file_both(i, args.nDev, length, "/workspace/RAP/breakdown_study/no_mapping/generated_data/", args.plan)
