...
// ======== Added Operators ========
#include "rec/logit.h" // @manual
#include "rec/boxcox.h" // @manual
#include "rec/onehot.h" // @manual
#include "rec/ngram.h" // @manual
#include "rec/mapid.h" // @manual
// =================================
...
inline void registerTorchArrowFunctions() {
  ...
  //   logit
//   velox::registerFunction<logit, float, float>({"logit"});
  velox::registerFunction<logit, float, float, float>({"logit"});
  velox::registerFunction<logit, velox::Array<float>, velox::Array<float>, float>({"logit"});

  //   boxcox
  velox::registerFunction<boxcox, float, float, float>({"boxcox"});
  velox::registerFunction<boxcox, velox::Array<float>, velox::Array<float>, float>({"boxcox"});

  //   onehot
  velox::registerFunction<onehot, velox::Array<float>, velox::Array<float>, float, float, int32_t>({"onehot"});
  velox::registerFunction<onehot, velox::Array<float>, velox::Array<float>, float, float, int64_t>({"onehot"});
  velox::registerFunction<onehot, velox::Array<float>, velox::Array<float>, int32_t, int32_t, int32_t>({"onehot"});
  velox::registerFunction<onehot, velox::Array<float>, velox::Array<float>, int32_t, int32_t, int64_t>({"onehot"});
  velox::registerFunction<onehot, velox::Array<float>, velox::Array<float>, int64_t, int64_t, int32_t>({"onehot"});
  velox::registerFunction<onehot, velox::Array<float>, velox::Array<float>, int64_t, int64_t, int64_t>({"onehot"});
  velox::registerFunction<onehot, velox::Array<int32_t>, velox::Array<int32_t>, float, float, int32_t>({"onehot"});
  velox::registerFunction<onehot, velox::Array<int32_t>, velox::Array<int32_t>, float, float, int64_t>({"onehot"});
  velox::registerFunction<onehot, velox::Array<int32_t>, velox::Array<int32_t>, int32_t, int32_t, int32_t>({"onehot"});
  velox::registerFunction<onehot, velox::Array<int32_t>, velox::Array<int32_t>, int32_t, int32_t, int64_t>({"onehot"});
  velox::registerFunction<onehot, velox::Array<int32_t>, velox::Array<int32_t>, int64_t, int64_t, int32_t>({"onehot"});
  velox::registerFunction<onehot, velox::Array<int32_t>, velox::Array<int32_t>, int64_t, int64_t, int64_t>({"onehot"});
  velox::registerFunction<onehot, velox::Array<int64_t>, velox::Array<int64_t>, float, float, int32_t>({"onehot"});
  velox::registerFunction<onehot, velox::Array<int64_t>, velox::Array<int64_t>, float, float, int64_t>({"onehot"});
  velox::registerFunction<onehot, velox::Array<int64_t>, velox::Array<int64_t>, int32_t, int32_t, int32_t>({"onehot"});
  velox::registerFunction<onehot, velox::Array<int64_t>, velox::Array<int64_t>, int32_t, int32_t, int64_t>({"onehot"});
  velox::registerFunction<onehot, velox::Array<int64_t>, velox::Array<int64_t>, int64_t, int64_t, int32_t>({"onehot"});
  velox::registerFunction<onehot, velox::Array<int64_t>, velox::Array<int64_t>, int64_t, int64_t, int64_t>({"onehot"});


  //   ngram
  velox::registerFunction<ngram, velox::Array<int64_t>, velox::Array<int64_t>, int32_t>({"ngram"});
  velox::registerFunction<ngram, velox::Array<int64_t>, velox::Array<int64_t>, int64_t>({"ngram"});
  velox::registerFunction<ngram, velox::Array<int32_t>, velox::Array<int32_t>, int32_t>({"ngram"});
  velox::registerFunction<ngram, velox::Array<int32_t>, velox::Array<int32_t>, int64_t>({"ngram"});
  velox::registerFunction<ngram, velox::Array<float>, velox::Array<float>, int32_t>({"ngram"});
  velox::registerFunction<ngram, velox::Array<float>, velox::Array<float>, int64_t>({"ngram"});

  //   mapid
  velox::registerFunction<mapid, velox::Array<int64_t>, velox::Array<int64_t>, velox::Array<int32_t>>({"mapid"});
  velox::registerFunction<mapid, velox::Array<int64_t>, velox::Array<int64_t>, velox::Array<int64_t>>({"mapid"});

//   velox::registerFunction<mapid, velox::Array<int64_t>, velox::Array<int64_t>, velox::Array<int32_t>>({"mapid"});
//   velox::registerFunction<mapid, velox::Array<int32_t>, velox::Array<int32_t>, velox::Array<int64_t>>({"mapid"});
//   velox::registerFunction<mapid, velox::Array<int32_t>, velox::Array<int32_t>, velox::Array<int64_t>>({"mapid"});
