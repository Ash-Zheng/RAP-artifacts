...
if not os.path.exists("/workspace/RAP/baseline_end_to_end/CUDA_stream/generated_data"):
    os.mkdir("/workspace/RAP/baseline_end_to_end/CUDA_stream/generated_data")
else:
    os.system("rm -rf /workspace/RAP/baseline_end_to_end/CUDA_stream/generated_data")
    os.mkdir("/workspace/RAP/baseline_end_to_end/CUDA_stream/generated_data")
...
for i in range(args.nDev):
    generate_parquet_file_both(i, args.nDev, length, "/workspace/RAP/baseline_end_to_end/CUDA_stream/generated_data/", args.plan)
